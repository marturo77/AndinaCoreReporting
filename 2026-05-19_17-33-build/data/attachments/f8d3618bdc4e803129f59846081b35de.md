...
```
Error: No se pudo confirmar que la pagina de cotizacion estuviera lista dentro de 80000 ms. URL actual: https://andinavidasegurospre.linktic.com/cotizaciones/nueva. Texto visible: [sin texto visible]
```
